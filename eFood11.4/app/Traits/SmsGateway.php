...
trait  SmsGateway
{
    public static function send($receiver, $otp): string
    {
        ...
        // Note: textsms_ke_not is not included here as it's not for OTP
        // It's only for branch notifications and doesn't participate in the OTP gateway selection
    ...
    /**
     * Send notification SMS to branch using textsms_ke_not gateway
