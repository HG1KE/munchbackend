...
class BusinessSettingsController extends Controller
{
    ...
    public function paymentConfigUpdate(Request $request): RedirectResponse
    {
        ...
        $validation = [
            'gateway' => 'required|in:ssl_commerz,paypal,stripe,pesapal,razor_pay,senang_pay,paystack,paymob_accept,flutterwave,bkash,mercadopago',
        ...
        } elseif ($request['gateway'] == 'pesapal') {
            $additionalData = [
                'status' => 'required|in:1,0',
                'consumer_key' => 'required_if:status,1',
                'consumer_secret' => 'required_if:status,1',
            ];
        }
