...
class SMSModuleController extends Controller
{
    ...
    public function smsIndex(): View|Factory|Application
    {
        ...
        $dataValues= Setting::where('settings_type','sms_config')->whereIn('key_name', ['twilio','nexmo','2factor','msg91', 'signal_wire', 'alphanet_sms', 'textsms_ke', 'textsms_ke_not'])->get() ?? [];
    ...
    {
        $validation = [
            'gateway' => 'required|in:twilio,nexmo,2factor,msg91,signal_wire,alphanet_sms,textsms_ke,textsms_ke_not',
        ];
