...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::setEnvironmentValue('SOFTWARE_VERSION', '11.4');
        ...
        if (BusinessSetting::where(['key' => 'pesapal'])->first() == false) {
            BusinessSetting::insert([
                'key' => 'pesapal',
                'value' => '{"status":"1","consumer_key":"","consumer_secret":""}'
            ]);
        }
        ...
        try{
            ...
            foreach($data as $key => $value){
                ...
                if ($gateway == 'ssl_commerz') {
                    ...
                    $additional_data = [
                        'status' => $decoded_value['status'],
                        'consumer_key' => $decoded_value['consumer_key'],
                        'consumer_secret' => $decoded_value['consumer_secret'],
                    ];
                }
