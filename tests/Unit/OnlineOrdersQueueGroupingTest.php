...
class OnlineOrdersQueueGroupingTest extends TestCase
{
    ...
    public function test_online_orders_ui_uses_meatco_classes_and_munch_name(): void
    {
        ...
        $this->assertStringContainsString("munch-pos-app.js') }}?v=5.0", file_get_contents(resource_path('views/branch-views/pos/index.blade.php')));
        ...
        $this->assertStringContainsString('munch-pos-shell-v29', file_get_contents(public_path('assets/admin/js/munch-pos-sw.js')));
