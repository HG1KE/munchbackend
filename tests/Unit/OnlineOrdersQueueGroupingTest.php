...
class OnlineOrdersQueueGroupingTest extends TestCase
{
    ...
    public function test_online_orders_ui_uses_meatco_classes_and_munch_name(): void
    {
        ...
        $this->assertStringContainsString('@if($showOnlineOrders)', $dashboard);
        ...
        $this->assertStringContainsString('pos-dine-in', $posPage);
        $this->assertStringContainsString('pos-table', $posPage);
        $this->assertStringContainsString('pos-people', $posPage);
        ...
        $ticketJs = file_get_contents(public_path('assets/admin/js/munch-receipt-ticket.js'));
        $this->assertStringContainsString('mpesaTill', file_get_contents(resource_path('views/branch-views/pos/index.blade.php')));
        $this->assertStringContainsString('mpesa_till:', $posJs);
        ...
        $this->assertStringContainsString('mpesa_till', $ticketJs);
        ...
        $this->assertStringContainsString("munch-pos-app.js') }}?v=3.1", file_get_contents(resource_path('views/branch-views/pos/index.blade.php')));
        $this->assertStringContainsString('munch-pos-dine-in.js', file_get_contents(resource_path('views/branch-views/pos/index.blade.php')));
        ...
        $this->assertStringContainsString('munch-pos-shell-v11', file_get_contents(public_path('assets/admin/js/munch-pos-sw.js')));
