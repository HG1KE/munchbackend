...
class ReceiptTemplateTest extends TestCase
{
    ...
    public function test_shared_renderer_keeps_kitchen_tickets_priceless(): void
    {
        ...
        $this->assertStringContainsString("munch-receipt-ticket.js') }}?v=2.0", file_get_contents(resource_path('views/branch-views/pos/index.blade.php')));
        ...
        $this->assertStringContainsString("munch-receipt-ticket.js') }}?v=2.0", file_get_contents(resource_path('views/admin-views/business-settings/receipt-templates.blade.php')));
