...
use App\Http\Controllers\Admin\BranchTimeScheduleController;
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.'], function () {
                ...
                Route::post('store-free-delivery-over-amount', [DeliveryChargeSetupController::class, 'storeFreeDeliveryOverAmount'])->name('store-free-delivery-over-amount');
                Route::post('store-free-delivery-over-status', [DeliveryChargeSetupController::class, 'storeFreeDeliveryOverStatus'])->name('store-free-delivery-over-status');
                ...
                Route::get('branch-time-schedule', [BranchTimeScheduleController::class, 'branchTimeScheduleIndex'])->name('branch_time_schedule_index');
                Route::post('add-branch-time-schedule', [BranchTimeScheduleController::class, 'addBranchSchedule'])->name('branch_time_schedule_add');
                Route::get('branch-time-schedule-remove', [BranchTimeScheduleController::class, 'removeBranchSchedule'])->name('branch_time_schedule_remove');
