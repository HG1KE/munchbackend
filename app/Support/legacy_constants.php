...
/**
 * Global constants previously declared in config/constant.php.
 * Loaded via Composer autoload files so they exist when config is cached.
 * config:cache includes config/*.php twice in one process; PHP const cannot be used there.
 */
if (defined('MUNCH_LEGACY_CONSTANTS_LOADED')) {
    return;
}
define('MUNCH_LEGACY_CONSTANTS_LOADED', true);
...
//
define('EXAMPLE_MAIL', 'example@example.com');
...
define('CATEGORIES_WITH_CHILDES', 'categories_with_childes');
...
define('OUT_FOR_DELIVERY', 'out_for_delivery');
...
define('ADD_WALLET_MESSAGE', 'add_wallet_message');
define('ADD_WALLET_BONUS_MESSAGE', 'add_wallet_bonus_message');

define('PAYMENT_GATEWAY_IMAGE_ARRAY',  [
