<?php return array (
  ...
  'Timeframe' => 'Timeframe',
  'Total Munch Sales' => 'Total Munch Sales',
  ...
  'profile' => 'Profile',
  'Home' => 'Home',
  'You have new order, Check Please.' => 'NEW ORDER. CHECK!',
  ...
  'debit_by_admin' => 'Debit by admin',
  'customer_wallet_adjustment' => 'Customer wallet adjustment',
  'adjust_wallet' => 'Adjust Wallet',
  'adjustment_type' => 'Adjustment Type',
  'reason_note' => 'Reason / Note',
  'current_balance' => 'Current balance',
  'resulting_balance' => 'Resulting balance',
  'wallet_adjusted_successfully' => 'Wallet adjusted successfully',
  'wallet_debit_exceeds_balance' => 'Debit amount exceeds the available wallet balance',
  'confirm_wallet_adjustment' => 'Confirm wallet adjustment',
  'invalid_wallet_adjustment_type' => 'Adjustment type must be credit or debit',
  ...
  'Offline Payment' => 'MPESA App Till',
  ...
  'Became online' => 'You’re Online',
  'Became offline' => 'You’re Offline',
  'You are in offline' => 'You are offline',
  ...
  'Shown to customers in POS Delivery SMS.' => 'Shown to customers in POS Delivery SMS.',
  'Invalid phone number' => 'Invalid phone number',
  'Enter a valid 10-digit phone number.' => 'Enter a valid 10-digit phone number.',
  'Order not posted' => 'Order not posted',
  'Posting order...' => 'Posting order...',
  'Order {n} posted successfully.' => 'Order {n} posted successfully.',
  ...
  'Refresh POS' => 'Refresh POS',
  'Order {n} posted successfully, but receipt printing failed.' => 'Order {n} posted successfully, but receipt printing failed.',
  'Order posted successfully, but receipt printing failed.' => 'Order posted successfully, but receipt printing failed.',
  ...
  'Platform Order No.' => 'Platform Order No.',
  'Platform' => 'Platform',
  'Done' => 'Done',
  ...
  'Placing...' => 'Placing...',
  'Queueing...' => 'Queueing...',
  'Could not save offline. Please try again.' => 'Could not save offline. Please try again.',
  'M-PESA' => 'M-PESA',
  'mpesa' => 'M-PESA',
  'PAID VIA GLOVO' => 'PAID VIA GLOVO',
  'PAID VIA UBER' => 'PAID VIA UBER',
  'PAID VIA BOLT FOOD' => 'PAID VIA BOLT FOOD',
  ...
  'Offline payment information' => 'MPESA Payment Info',
  'payment_note' => 'Payment note',
  ...
  'Please Check & Verify the payment information whether it is correct or not before confirm the order.' => 'Please verify if you received this payment before proceeding.',
  'customer_Information' => 'Customer Information',
  'Payment_Information' => 'Payment Information',
  'Payment_Did_Not_Received' => 'Payment Not Received',
  ...
  'Payment_verification' => 'Payment verification',
  'please verify the payment before confirm order' => 'Please verify the payment before proceeding',
  ...
  'Offline payment is not verified' => 'We couldn\'t verify your mobile money payment. Kindly try again.',
  'Chef List' => 'Chef List',
  'Chef_List' => 'Chef List',
  ...
  'razor_pay' => 'Razor pay',
  'offline_payment' => 'MPESA App Till',
  ...
  'successfully removed!' => 'Successfully removed!',
  '1 KES Equal to How Much Loyalty Points?' => '1 KES Equal to How Much Loyalty Points?',
  'One Referrer Equal To How Much (KES' => 'One Referrer Equal To How Much (KES',
  'Error' => 'Error',
  'Looks like we encountered a slight problem. Worry not, press the back button to return to app.' => 'Looks like we encountered a slight problem. Worry not, press the back button to return to app.',
  ...
  'Sl' => 'Sl',
  '1 USD Equal to How Much Loyalty' => '1 USD Equal to How Much Loyalty',
  ...
  'Wallet section to complete this settings' => 'Wallet section to complete this settings',
  'Validity' => 'Validity',
  ...
  'Customer Wallet' => 'Customer Wallet',
  'When active this feature customer can Earn and Buy through wallet. See customer wallet from Customers Details page' => 'When active this feature customer can Earn and Buy through wallet. See customer wallet from Customers Details page',
  'You can add funds to your wallet to make quick and easy payments within the app' => 'You can add funds to your wallet to make quick and easy payments within the app',
  'When active this feature customer can Earn and Buy through wallet. See customer wallet from Customers Details page.' => 'When active this feature customer can Earn and Buy through wallet. See customer wallet from Customers Details page.',
  'View' => 'View',
  ...
  'By applying the referral code during signup and when making their first purchase customers will enjoy a discount for a limited time.' => 'By applying the referral code during signup and when making their first purchase customers will enjoy a discount for a limited time.',
  'Day' => 'Day',
  'Week' => 'Week',
  'Month' => 'Month',
  ...
  'This point is the required amount which is needed to convert the point to the wallet balance' => 'This point is the required amount which is needed to convert the point to the wallet balance',
  'Message successfully sent' => 'Message successfully sent',
  'Payment' => 'Payment',
  9660917 => '9660917',
  'MPESA Code' => 'MPESA Code',
  ...
  'branch_availability_time_slot' => 'Branch Availability Time Slot',
  'branch_availability_time_slots' => 'Branch Availability Time Slots',
  'using_restaurant_schedule' => 'Using Restaurant Schedule',
  'branch_availability_must_be_within_restaurant_availability' => 'Branch availability must be within restaurant availability time slots',
  'order_cannot_be_placed_outside_branch_availability_hours' => 'Order cannot be placed outside branch availability hours',
  'branch_is_not_available' => 'Branch is not available',
  'branch_is_closed_for_today' => 'Branch is closed for today. You cannot place orders after closing time.',
  'orders_can_only_be_placed_for_today' => 'Orders can only be placed for today. Future date scheduling is not allowed.',
  'set_branch_specific_availability' => 'Set your branch specific availability time slots. If no time slot is set, your branch will use the Restaurant Availability Time Slot.',
  'track_deliverymen' => 'Track deliverymen',
  'translations' => 'Translations',
  'wallet_bonuses' => 'Wallet bonuses',
  'wallet_transactions' => 'Wallet transactions',
  'wishlists' => 'Wishlists',
  'MPESA Name' => 'MPESA Name',
  'MPESA Transaction Code' => 'MPESA Transaction Code',
  'Addon updated successfully!' => 'Addon updated successfully!',
  'order delivery area updated' => 'Order delivery area updated',
  'The phone is already taken' => 'The phone is already taken',
  'OTP is not matched.' => 'OTP is not matched.',
  'Bulk_Export' => 'Bulk Export',
  'STEP 1' => 'STEP 1',
  'Payment request id not found!' => 'Payment request id not found!',
  ...
  'textsms_ke' => 'Textsms ke',
  'partner_id' => 'Partner id',
  'sender_id' => 'Sender id',
  'textsms_ke_not' => 'Textsms ke not',
  'notification_template' => 'Notification template',
  'is_otp_gateway' => 'Is otp gateway',
  'Available variables:' => 'Available variables:',
  'includes delivery charge' => 'Includes delivery charge',
  'Phone number is successfully verified' => 'Phone number is successfully verified',
  'Addon removed!' => 'Addon removed!',
  'Branch_Availability_Time_Slot' => 'Branch Availability Time Slot',
  'Set specific availability time slots for each branch. If no time slot is set for a branch, it will use the Restaurant Availability Time Slot.' => 'Set specific availability time slots for each branch. If no time slot is set for a branch, it will use the Restaurant Availability Time Slot.',
  'Using Restaurant Schedule' => 'Using Restaurant Schedule',
  'Create Branch Schedule' => 'Create Branch Schedule',
  'Start Time' => 'Start Time',
  'End Time' => 'End Time',
  'Note' => 'Note',
  'Branch availability must be within the Restaurant Availability Time Slot for the selected day.' => 'Branch availability must be within the Restaurant Availability Time Slot for the selected day.',
  'Schedule added successfully!' => 'Schedule added successfully!',
  'You will not be able to revert this!' => 'You will not be able to revert this!',
  'Schedule removed successfully!' => 'Schedule removed successfully!',
  'Branch availability must be within restaurant availability time slots' => 'Branch availability must be within restaurant availability time slots',
  'Setup loyalty point percentage earned by customer based on order amount' => 'Setup loyalty point percentage earned by customer based on order amount',
  ...
  'coupon_limit_over' => 'Coupon limit over',
  'This user is not active!' => 'This user is not active!',
  'textsms_ke_customer_confirm' => 'Textsms ke customer confirm',
  'order_placed_template' => 'Order placed template',
  'processing_template' => 'Processing template',
  'textsms_ke_abandoned_cart' => 'Textsms ke abandoned cart',
  ...
  'Promotional SMS gateway' => 'Promotional SMS gateway',
  'Abandoned Checkout' => 'Abandoned Checkout',
  'SMS Queue / Activity' => 'SMS Queue / Activity',
  'Marketing' => 'Marketing',
  'Global marketing TextSMS credentials' => 'Global marketing TextSMS credentials',
  'Used by abandoned checkout and future promotional campaigns' => 'Used by abandoned checkout and future promotional campaigns',
  'http_timeout_seconds' => 'Http timeout seconds',
  'Campaign settings' => 'Campaign settings',
  'Credentials are configured under Promotional SMS gateway' => 'Credentials are configured under Promotional SMS gateway',
  'Campaign' => 'Campaign',
  'sent_at' => 'Sent at',
  'provider' => 'Provider',
  'retries' => 'Retries',
  'Shows promotional SMS send attempts only' => 'Shows promotional SMS send attempts only',
  'sent' => 'Sent',
  'Checkout rows with no SMS activity are hidden' => 'Checkout rows with no SMS activity are hidden',
  'Message body is rendered from the current template and row data' => 'Message body is rendered from the current template and row data',
  'SMS message' => 'SMS message',
  'Storefront visibility schedule' => 'Storefront visibility schedule',
  'Visible from' => 'Visible from',
  'Visible until' => 'Visible until',
  'Leave both empty for normal visibility when the product is active. End time is exclusive at the exact timestamp.' => 'Leave both empty for normal visibility when the product is active. End time is exclusive at the exact timestamp.',
  'Clear storefront visibility schedule' => 'Clear storefront visibility schedule',
  'One-time visibility window' => 'One-time visibility window',
  'Recurring weekly visibility' => 'Recurring weekly visibility',
  'Products appear on the storefront when the current day and time match any rule. Overnight windows are not supported (end must be after start on the same clock day).' => 'Products appear on the storefront when the current day and time match any rule. Overnight windows are not supported (end must be after start on the same clock day).',
  'Weekday' => 'Weekday',
  '— None —' => '— None —',
  'Start' => 'Start',
  'End' => 'End',
  'Clear all recurring weekly rules' => 'Clear all recurring weekly rules',
  'Manage Munch Operations' => 'Manage Munch Operations',
  'Orders, branches, marketing and analytics in one dashboard.' => 'Orders, branches, marketing and analytics in one dashboard.',
  'Toggle password visibility' => 'Toggle password visibility',
  'Login as Branch / Employee' => 'Login as Branch / Employee',
  'Manage Branch Operations' => 'Manage Branch Operations',
  'Orders, kitchen flow and branch performance in one dashboard.' => 'Orders, kitchen flow and branch performance in one dashboard.',
  'The email field is required.' => 'The email field is required.',
  'The email must be a valid email address.' => 'The email must be a valid email address.',
  'Live_now' => 'Live now',
  'Storefront activity in the last few minutes' => 'Storefront activity in the last few minutes',
  'Visitors on website' => 'Visitors on website',
  'Last 5 minutes' => 'Last 5 minutes',
  'Active carts' => 'Active carts',
  'Cart with items' => 'Cart with items',
  'Checking out' => 'Checking out',
  'On checkout screen' => 'On checkout screen',
  'Updated' => 'Updated',
  ...
  'Failed to load order products' => 'Failed to load order products',
  'Order edit is not available on this installation.' => 'Order edit is not available on this installation.',
  'Send order summary to WhatsApp' => 'Send order summary to WhatsApp',
  'Send to WhatsApp' => 'Send to WhatsApp',
  'WhatsApp' => 'WhatsApp',
  'Opening WhatsApp...' => 'Opening WhatsApp...',
  'Reorder Reminders' => 'Reorder Reminders',
  'Abandoned Checkout Activity' => 'Abandoned Checkout Activity',
  'Reorder Reminder Activity' => 'Reorder Reminder Activity',
  'Abandoned checkout recovery SMS only' => 'Abandoned checkout recovery SMS only',
  'Placeholders' => 'Placeholders',
  'Delay Days' => 'Delay Days',
  'Days since last delivered order' => 'Days since last delivered order',
  'Minimum Completed Orders' => 'Minimum Completed Orders',
  'Cooldown Days' => 'Cooldown Days',
  'Branch IDs' => 'Branch IDs',
  'Comma-separated branch IDs. Leave empty for all branches.' => 'Comma-separated branch IDs. Leave empty for all branches.',
  'Send test SMS' => 'Send test SMS',
  'Test phone number' => 'Test phone number',
  'Send test' => 'Send test',
  'Reorder reminder SMS queue' => 'Reorder reminder SMS queue',
  'queued' => 'Queued',
  'skipped' => 'Skipped',
  ...
  'queued_at' => 'Queued at',
  'delay' => 'Delay',
  'Loyalty Delivery SMS' => 'Loyalty Delivery SMS',
  'Loyalty Delivery Activity' => 'Loyalty Delivery Activity',
  'Sent when loyalty points are credited after a delivered order. Credentials use Promotional SMS gateway.' => 'Sent when loyalty points are credited after a delivered order. Credentials use Promotional SMS gateway.',
  'Sent when loyalty points are credited after a delivered order. Uses the same transactional TextSMS gateway as customer order confirmation SMS (not promotional).' => 'Sent when loyalty points are credited after a delivered order. Uses the same transactional TextSMS gateway as customer order confirmation SMS (not promotional).',
  'Loyalty Delivery SMS Activity' => 'Loyalty Delivery SMS Activity',
  'Transactional SMS after loyalty points are credited on delivered orders' => 'Transactional SMS after loyalty points are credited on delivered orders',
  'Sent when loyalty points are credited after a delivered order. This campaign must be Active, and Customer order confirmation SMS (transactional gateway) must also be active with credentials. Test SMS can work even when this campaign is inactive.' => 'Sent when loyalty points are credited after a delivered order. This campaign must be Active, and Customer order confirmation SMS (transactional gateway) must also be active with credentials. Test SMS can work even when this campaign is inactive.',
  'Order Automation' => 'Order Automation',
  'Bulk and scheduled completions use the same delivered transition as manual admin status updates (loyalty points, loyalty SMS, customer notifications).' => 'Bulk and scheduled completions use the same delivered transition as manual admin status updates (loyalty points, loyalty SMS, customer notifications).',
  'Automatic completion' => 'Automatic completion',
  'Enabled' => 'Enabled',
  'Disabled' => 'Disabled',
  'Auto-complete after (hours)' => 'Auto-complete after (hours)',
  'Eligible statuses' => 'Eligible statuses',
  'Always exclude statuses' => 'Always exclude statuses',
  'Scheduled dry-run mode' => 'Scheduled dry-run mode',
  'Live (send updates)' => 'Live (send updates)',
  'Dry run (log only)' => 'Dry run (log only)',
  'Save settings' => 'Save settings',
  'Manual bulk completion' => 'Manual bulk completion',
  'Eligible now' => 'Eligible now',
  'Marks all currently eligible active orders as delivered (no age filter). Uses the standard delivered pipeline.' => 'Marks all currently eligible active orders as delivered (no age filter). Uses the standard delivered pipeline.',
  'Refresh count' => 'Refresh count',
  'Mark Eligible Orders Delivered' => 'Mark Eligible Orders Delivered',
  'Recent automation runs' => 'Recent automation runs',
  'Dry run' => 'Dry run',
  'Eligible' => 'Eligible',
  'Skipped' => 'Skipped',
  'Failed' => 'Failed',
  'Finished' => 'Finished',
  'Confirm bulk delivery' => 'Confirm bulk delivery',
  'This will mark' => 'This will mark',
  'eligible orders as delivered.' => 'Eligible orders as delivered.',
  'Loyalty points, loyalty delivery SMS, and customer notifications will run per order.' => 'Loyalty points, loyalty delivery SMS, and customer notifications will run per order.',
  'Confirm' => 'Confirm',
  'Last automation run' => 'Last automation run',
  'Details' => 'Details',
  'Require assigned deliveryman before auto-complete' => 'Require assigned deliveryman before auto-complete',
  'When off, delivery orders without a rider can still be auto-completed. Takeaway, dine-in, and POS orders never require a rider.' => 'When off, delivery orders without a rider can still be auto-completed. Takeaway, dine-in, and POS orders never require a rider.',
  'On' => 'On',
  'Off' => 'Off',
  ...
  'Live kitchen prep and rider dispatch' => 'Live kitchen prep and rider dispatch',
  '60–90 min delivery · alerts enabled' => '60–90 min delivery · alerts enabled',
  'Kitchen prep and rider dispatch — live online operations' => 'Kitchen prep and rider dispatch — live online operations',
  'Back to Dashboard' => 'Back to Dashboard',
  'Waiting to enter preparation' => 'Waiting to enter preparation',
  'Kitchen and preparation workflow' => 'Kitchen and preparation workflow',
  'Rider and distribution tracking' => 'Rider and distribution tracking',
  'Orders waiting to be accepted into the kitchen.' => 'Orders waiting to be accepted into the kitchen.',
  'Orders currently being prepared.' => 'Orders currently being prepared.',
  'Orders that are out for delivery.' => 'Orders that are out for delivery.',
  'No orders in this section.' => 'No orders in this section.',
  'No pending online orders.' => 'No pending online orders.',
  'No packing online orders.' => 'No packing online orders.',
  'No orders currently being prepared.' => 'No orders currently being prepared.',
  'No dispatched orders right now.' => 'No dispatched orders right now.',
  'Packing' => 'Packing',
  'Preparing' => 'Preparing',
  ...
  'Amount' => 'Amount',
  'Payment' => 'Payment',
  'Time Since Order Placed' => 'Time Since Order Placed',
  'Prep to dispatch time' => 'Prep to dispatch time',
  'Fulfillment time' => 'Fulfillment time',
  'Out for delivery' => 'Out for delivery',
  'Dispatch ASAP' => 'Dispatch ASAP',
  'Delivered in' => 'Delivered in',
  'Order fulfilled — SLA closed' => 'Order fulfilled — SLA closed',
  'Frozen at dispatch — prep SLA complete' => 'Frozen at dispatch — prep SLA complete',
  'Target delivery: 60–90 mins' => 'Target delivery: 60–90 mins',
  'Delivery' => 'Delivery',
  'Dine In' => 'Dine In',
  ...
  'Order saved offline' => 'Order saved offline',
  'In-store' => 'In-store',
  ...
  'Kitchen Order Printed' => 'Kitchen Order Printed',
  'Receipt Printed' => 'Receipt Printed',
  'TextSMS Transactional' => 'TextSMS Transactional',
  'TextSMS Promotional' => 'TextSMS Promotional',
  'SMS Gateway Configuration' => 'SMS Gateway Configuration',
  'Configure TextSMS credentials here. Assign which gateway sends each message on Transactional SMS Templates.' => 'Configure TextSMS credentials here. Assign which gateway sends each message on Transactional SMS Templates.',
  'Uses the TextSMS transactional sendsms endpoint. OTP still uses the official sendotp URL.' => 'Uses the TextSMS transactional sendsms endpoint. OTP still uses the official sendotp URL.',
  'Independent promotional credentials and endpoint. Marketing campaigns use this gateway.' => 'Independent promotional credentials and endpoint. Marketing campaigns use this gateway.',
  'Other SMS gateways' => 'Other SMS gateways',
  'Twilio, Nexmo and other OTP providers are unchanged.' => 'Twilio, Nexmo and other OTP providers are unchanged.',
  'endpoint' => 'Endpoint',
  'Test SMS' => 'Test SMS',
  'Transactional SMS' => 'Transactional SMS',
  'Transactional SMS Templates' => 'Transactional SMS Templates',
  'SMS Templates' => 'SMS Templates',
  'Each template can be enabled independently and sent through TextSMS Transactional or TextSMS Promotional. Gateway credentials are configured under SMS Config.' => 'Each template can be enabled independently and sent through TextSMS Transactional or TextSMS Promotional. Gateway credentials are configured under SMS Config.',
  'SMS templates updated successfully' => 'SMS templates updated successfully',
  'Gateway' => 'Gateway',
  'Customer OTP' => 'Customer OTP',
  'Login OTP' => 'Login OTP',
  'Branch new order' => 'Branch new order',
  'Order Placed' => 'Order Placed',
  'Processing' => 'Processing',
  ...
  'Also used for login OTP. Uses the TextSMS OTP endpoint.' => 'Also used for login OTP. Uses the TextSMS OTP endpoint.',
  'Login currently uses the Customer OTP template and send path. Stored here so the gateway can be chosen independently later.' => 'Login currently uses the Customer OTP template and send path. Stored here so the gateway can be chosen independently later.',
  'Sent to the branch phone when a new order is placed.' => 'Sent to the branch phone when a new order is placed.',
  'Customer SMS when an order is placed.' => 'Customer SMS when an order is placed.',
  'Customer SMS when an order moves to processing.' => 'Customer SMS when an order moves to processing.',
  'Ready for routing. No send trigger is attached yet.' => 'Ready for routing. No send trigger is attached yet.',
  'Ready for routing. Loyalty delivery SMS stays on the Marketing campaign page.' => 'Ready for routing. Loyalty delivery SMS stays on the Marketing campaign page.',
  'Promotional credentials live under Business Settings → Web App → Third Party → SMS Config (TextSMS Promotional). This page no longer duplicates that form.' => 'Promotional credentials live under Business Settings → Web App → Third Party → SMS Config (TextSMS Promotional). This page no longer duplicates that form.',
  'Current status' => 'Current status',
  'Open SMS Config' => 'Open SMS Config',
  'Sent when loyalty points are credited after a delivered order. This campaign must be Active, and TextSMS Transactional must also be active with credentials. Test SMS can work even when this campaign is inactive.' => 'Sent when loyalty points are credited after a delivered order. This campaign must be Active, and TextSMS Transactional must also be active with credentials. Test SMS can work even when this campaign is inactive.',
