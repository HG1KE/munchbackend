...
<div class="meatco-operations-panel meatco-ops-dashboard" id="munch-dashboard-live-root" data-live-cards-url="{{ $liveCardsUrl ?? route('admin.dashboard.live-cards') }}">
    ...
    <div class="meatco-ops-dashboard__grid{{ $posRoute ? '' : ' meatco-ops-dashboard__grid--single' }}">
