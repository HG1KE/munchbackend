                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('mpesa_till', $branch['mpesa_till'] ?? '') }}" type="text" name="mpesa_till" id="mpesa_till" class="form-control" inputmode="numeric" pattern="[0-9]*" maxlength="12" placeholder="{{ translate('Ex: 123456') }}" autocomplete="off">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="d-flex align-items-center justify-content-between gap-3">
                                                    <label class="input-label mb-0" for="online_orders_enabled">{{ translate('Online Orders') }}</label>
                                                    <input type="hidden" name="online_orders_enabled" value="0">
                                                    <label class="switcher mb-0">
                                                        <input class="switcher_input" type="checkbox" name="online_orders_enabled" id="online_orders_enabled" value="1" {{ (int) old('online_orders_enabled', $branch['online_orders_enabled'] ?? 1) === 1 ? 'checked' : '' }}>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </div>
                                                <small class="text-muted">{{ translate('Enabled') }} / {{ translate('Disabled') }}. {{ translate('When disabled, this branch will not see or ring for Online Orders. Customers can still order and Admin still receives them.') }}</small>
                                            </div>
                                        </div>
