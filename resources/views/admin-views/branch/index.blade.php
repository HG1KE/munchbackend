                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="d-flex align-items-center justify-content-between gap-3">
                                                    ...
                                                    <label class="switcher mb-0">
                                                        <input class="switcher_input" type="checkbox" name="online_orders_enabled" id="online_orders_enabled" value="1" {{ (int) old('online_orders_enabled', 1) === 1 ? 'checked' : '' }}>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{old('preparation_time')}}" type="number" name="preparation_time" class="form-control"
                                                       placeholder="{{ translate(' Ex')}}: {{ translate('30') }}" min="1" required>
                                            </div>
                                        </div>
                                    </div>
