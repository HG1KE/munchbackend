...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/admin/css/munch-product-pricing.css') }}?v=1.4">
@endpush
...
@push('script_2')
    ...
    <script src="{{ asset('public/assets/admin/js/munch-product-pricing.js') }}?v=1.9"></script>
@endpush
