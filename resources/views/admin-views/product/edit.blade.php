            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="javascript:" method="post" id="product_form" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between gap-sm-3 gap-1 flex-sm-nowrap flex-wrap">
                                                    ...
                                                    <div class="d-flex gap-3 align-items-center">
                                                        ...
                                                        <label class="switcher">
                                                            ...
                                                            <input class="switcher_input" type="checkbox" {{ $product->main_branch_product?->halal_status == 1 ? "checked" : '' }} name="halal_status">
                        ...
                        <div class="col-lg-6">
                            <div class="row g-2">
                                @include('admin-views.product.partials._storefront-visibility-schedule')
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-sm-3 gap-1 flex-sm-nowrap flex-wrap">
                                                ...
                                                <div class="d-flex gap-3 align-items-center">
                                                    ...
                                                    <label class="switcher">
                                                        <input class="switcher_input" type="checkbox" name="allow_addon_on_pos" {{ ($product->allow_addon_on_pos ?? false) ? 'checked' : '' }}>
                                                        <span class="switcher_control"></span>
                                                    </label>
                                                </div>
                                            </div>
