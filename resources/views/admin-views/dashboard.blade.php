        ...
        <div class="content container-fluid">
            ...
            <div class="card card-body mb-3">
                @include('partials._dashboard-online-orders', [
                    ...
                    'onlineRoute' => 'admin.orders.online',
                    'liveCardsUrl' => route('admin.dashboard.live-cards'),
                ])
            </div>
...
{{--    @endif--}}
        ...
        @push('script_2')
            ...
            <script src="{{ asset('public/assets/admin/js/munch-dashboard-kpis.js') }}?v=1.2"></script>
