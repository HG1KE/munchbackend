    ...
    <div class="row justify-content-md-end">
        <div class="col-md-9 col-lg-9">
            <dl class="row text-right custom-dl">
                ...
                <dd class="col-4">{{Helpers::set_symbol($itemPrice)}}</dd>
                ...
                @php($subtotal = $addOnsCost + $itemPrice + $totalTax + $addOnsTaxCost - $order['coupon_discount_amount'] - $order['extra_discount'])
                ...
                <dd class="col-6 custom-text-size">{{ Helpers::set_symbol($subtotal+$deliveryCharge) }}</dd>
