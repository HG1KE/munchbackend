                        ...
                        <form action="{{route('admin.business-settings.update-fcm-messages')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="row">
                                    ...
                                    @php($notify_for_time_change_data= json_decode($notify_for_time_change?->value, true))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                    ...
                                    @php($register_with_referral_code= \App\Model\BusinessSetting::with('translations')->where(['key' => 'register_with_referral_code_message'])->first())
                                    @php($register_with_referral_code_data= json_decode($register_with_referral_code?->value, true))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <label class="switcher" for="register_with_referral_code_status">
                                                    <input type="checkbox" name="register_with_referral_code_status" class="switcher_input"
                                                           value="1" id="register_with_referral_code_status" {{(isset($register_with_referral_code_data['status']) && $register_with_referral_code_data['status']==1)?'checked':''}}>
                                                    <span class="switcher_control"></span>
                                                </label>
                                                <span class="text-dark">{{translate('register_with_referral_code_message')}}</span>
                                            </div>

                                            <textarea name="register_with_referral_code_message" class="form-control">{{$register_with_referral_code_data['message']??''}}</textarea>
                                        </div>
                                    </div>

                                    @php($referral_code_user_first_order_place= \App\Model\BusinessSetting::with('translations')->where(['key' => 'referral_code_user_first_order_place_message'])->first())
                                    @php($referral_code_user_first_order_place_data= json_decode($referral_code_user_first_order_place?->value, true))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <label class="switcher" for="referral_code_user_first_order_place_status">
                                                    <input type="checkbox" name="referral_code_user_first_order_place_status" class="switcher_input"
                                                           value="1" id="referral_code_user_first_order_place_status" {{(isset($referral_code_user_first_order_place_data['status']) && $referral_code_user_first_order_place_data['status']==1)?'checked':''}}>
                                                    <span class="switcher_control"></span>
                                                </label>
                                                <span class="text-dark">{{translate('referral_code_user_first_order_place_message')}}</span>
                                            </div>

                                            <textarea name="referral_code_user_first_order_place_message" class="form-control">{{$referral_code_user_first_order_place_data['message']??''}}</textarea>
                                        </div>
                                    </div>

                                    @php($referral_code_user_first_order_delivered= \App\Model\BusinessSetting::with('translations')->where(['key' => 'referral_code_user_first_order_delivered_message'])->first())
                                    @php($referral_code_user_first_order_delivered_data= json_decode($referral_code_user_first_order_delivered?->value, true))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="d-flex align-items-center gap-3 mb-3">
                                                <label class="switcher" for="referral_code_user_first_order_delivered_status">
                                                    <input type="checkbox" name="referral_code_user_first_order_delivered_status" class="switcher_input"
                                                           value="1" id="referral_code_user_first_order_delivered_status" {{(isset($referral_code_user_first_order_delivered_data['status']) && $referral_code_user_first_order_delivered_data['status']==1)?'checked':''}}>
                                                    <span class="switcher_control"></span>
                                                </label>
                                                <span class="text-dark">{{translate('referral_code_user_first_order_delivered_message')}}</span>
                                            </div>

                                            <textarea name="referral_code_user_first_order_delivered_message" class="form-control">{{$referral_code_user_first_order_delivered_data['message']??''}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <?php
                                                    $notification_message_array = [
                                                      [
                                                          ...
                                                          'field_name' => 'register_with_referral_code_bonus',
                                                          'object' => $register_with_referral_code
                                                      ],[
                                                          'field_name' => 'referral_code_user_first_order_place_bonus',
                                                          'object' => $referral_code_user_first_order_place
                                                      ],[
                                                          'field_name' => 'referral_code_user_first_order_delivered_bonus',
                                                          'object' => $referral_code_user_first_order_delivered
                                                      ],
                                                    ];
