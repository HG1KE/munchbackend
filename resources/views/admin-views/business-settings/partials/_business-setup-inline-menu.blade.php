<div class="mt-5 mb-5">
    <div class="inline-page-menu my-4">
        <ul class="list-unstyled">
            ...
            <li class="{{Request::is('admin/business-settings/restaurant/branch-time-schedule')? 'active' : ''}}"><a href="{{route('admin.business-settings.restaurant.branch_time_schedule_index')}}">{{translate('Branch_Availability_Time_Slot')}}</a></li>
            ...
            <li class="{{Request::is('admin/business-settings/restaurant/receipt-templates*')? 'active' : ''}}"><a href="{{route('admin.business-settings.restaurant.receipt-templates')}}">{{translate('Receipt Templates')}}</a></li>
