                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                <div>
                                    <label class="text-dark mb-0">{{translate('Halal tag status')}}
                                        <i class="tio-info-outined"
                                           data-toggle="tooltip"
                                           data-placement="top"
                                           title="{{ translate('A Halal tag means the food or drink follows Islamic rules about what is allowed to eat or drink.') }}">
                                        </i>
                                    </label>
                                </div>
                                <label class="switcher">
                                    <input name="halal_tag_status"
                                        ...
                                        data-image="{{ asset('public/assets/admin/img/halal-tags.png') }}"
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.show-global-confirmation-modal', function (e) {
                ...
                const dynamicTitle = shouldBeChecked
                    ? "{{ translate('Turn on the Halal Tag Status') }} ?"
                    : "{{ translate('Turn off the Halal Tag Status') }} ?";

                const dynamicMessage = shouldBeChecked
                    ? "{{ translate('Activating this, a Halal tag will be visible with the relevant food items. Please note after enabling this feature, you will also need to set the Halal status for each product item individually within the Product Setup.') }}"
                    : "{{ translate('Deactivating this, Halal tag will not be visible with the relevant food items.') }}";

                const image = toggleElement.data('image');
