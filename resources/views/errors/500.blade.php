...
<head>
    ...
    <title>{{ translate('Error') }} | {{ \App\CentralLogics\Helpers::get_business_settings('restaurant_name') }}</title>
    ...
    <div class="footer-height-offset d-flex justify-content-center align-items-center flex-column">
        <div class="row align-items-sm-center w-100">
            ...
            <div class="col-sm-6 col-md-4 text-center text-sm-left">
                ...
                <p class="lead">{{ translate('Looks like we encountered a slight problem. Worry not, press the back button to return to app.') }}</p>
