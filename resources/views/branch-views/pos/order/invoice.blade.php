    ...
    <div class="row justify-content-end">
        <div class="col-md-9 col-lg-9">
            <dl class="row text-right custom-dl">
                ...
                <dd class="col-4">{{ Helpers::set_symbol($addOnsCost) }}</dd>

                <dt class="col-8">{{translate('Coupon Discount')}}:</dt>
                <dd class="col-4">-{{ Helpers::set_symbol($order['coupon_discount_amount']) }}</dd>

                <dt class="col-8">{{translate('Extra Discount')}}:</dt>
                <dd class="col-4">-{{ Helpers::set_symbol($order['extra_discount']) }}</dd>

                <dt class="col-8">{{translate('Tax')}} / {{translate('VAT')}}:</dt>
                <dd class="col-4">{{ Helpers::set_symbol($totalTax + $addOnsTaxCost) }}
                    <hr>
                </dd>

                <dt class="col-8">{{translate('Subtotal')}}:</dt>
                <dd class="col-4">
                    {{ Helpers::set_symbol($subTotal+$totalTax+$addOnsCost+$addOnsTaxCost-$order['coupon_discount_amount']-$order['extra_discount']) }}
                </dd>
                ...
                @if ($order->order_partial_payments->isNotEmpty())
                    ...
                    <dt class="col-6">
                        <div class="">
                            <span>{{translate('Due Amount')}}</span><span>:</span>
                        </div>
                    </dt>
                    <dd class="col-6 text-dark text-right">
